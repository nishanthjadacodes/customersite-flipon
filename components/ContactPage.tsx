...
// Shared Contact page body. Rendered by BOTH /contact and /contact-us
// so the helpline/WhatsApp/email/address values live in exactly one
// place. The Footer also references support@fliponex.com — keep these
// two in sync when contact details change.
