...
// Shared Terms & Conditions page body. Rendered by BOTH /terms and
// /terms-and-conditions so the actual legal text lives in exactly
// one place. See PrivacyPage.tsx for the rationale.
